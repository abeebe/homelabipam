...
export default function SettingsPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      // Reload to reflect any server-side masking
      await loadSettings()
    } catch (err) {
      ...
      <div className="settings-section">
        <div className="settings-section-header">
          <div>
            ...
            <p className="settings-section-desc">
              ...
              Requires the Network Integration API key (Settings → System → Integrations in UniFi).
            </p>
          </div>
          <button
        ...
        <div className="settings-fields">
          <div className="settings-field">
            ...
            <p className="field-hint">The base URL of your UniFi controller, e.g. <code>https://10.10.1.1</code></p>
            <input
              id="unifi-url"
              type="text"
              value={values.UNIFI_URL}
          ...
          <div className="settings-field">
            ...
            <p className="field-hint">
              ...
              {values.UNIFI_API_KEY === PLACEHOLDER && (
        ...
        <div className="settings-fields">
          ...
          <div className="settings-field">
            ...
            <input
              id="proxmox-token-id"
              type="text"
              value={values.PROXMOX_TOKEN_ID}
              onChange={e => set('PROXMOX_TOKEN_ID', e.target.value)}
              placeholder="root@pam!ipam"
              disabled
            />
          </div>
          ...
          <div className="settings-field">
            ...
            <p className="field-hint">
              ...
              {values.PROXMOX_TOKEN_SECRET === PLACEHOLDER && (
                <span className="configured-badge"> ✓ Configured</span>
              )}
            </p>
            <input
              ...
              type="password"
              value={values.PROXMOX_TOKEN_SECRET}
